  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <button
        ...
        className="fixed bottom-24 right-5 z-40 w-14 h-14 rounded-full bg-[#F97316] text-white flex items-center justify-center active:scale-95 transition-transform"
        style={{
          marginBottom: "env(safe-area-inset-bottom, 0px)",
          boxShadow: "0 10px 28px -8px rgba(249, 115, 22, 0.5), 0 2px 6px rgba(15, 23, 42, 0.08)",
        }}
      >
